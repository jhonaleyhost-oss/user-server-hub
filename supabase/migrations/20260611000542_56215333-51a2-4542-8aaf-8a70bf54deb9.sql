...
BEGIN
  ...
  -- BONUS: Grant reseller role for SAME duration as ad package
  ...
  RETURN jsonb_build_object('success', true, 'user_id', v_rental.user_id, 'expires_at', v_end, 'reseller_until', v_new_exp, 'duration_days', v_days);
END;
$function$;
